package cn.wwah.common.myutils;
...
/**
 * 作者：陆同富 on 2016/4/29 002919:35
 * 邮箱：xmltf@kdiantech.com
 */
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _multipart = new MimeMultipart();      // There is something wrong with MailCap, javamail can not find a
    ...
    public boolean send() throws Exception {
        ...
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("") &&
            ...
            _multipart.addBodyPart(messageBodyPart);        // Put parts title_popup_left_in message
